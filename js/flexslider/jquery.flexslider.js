  ...
  $.flexslider = function(el, options) {
    ...
    slider.init = function() {
      ...
      if (slider.vars.animation.toLowerCase() == "slide") {
        ...
        if (slider.vertical) {
          slider.newSlides.css({"display": "block", "width": "85%", "float": "left"});
          slider.container.height((slider.count + slider.cloneCount) * 100 + "%").css("position", "absolute").width("85%");
          ...
          slider.container.width((slider.count + slider.cloneCount) * 100 + "%").css(slider.args);
        ...
        slider.slides.css({"width": "85%", "float": "left", "marginRight": "-85%"}).eq(slider.currentSlide).fadeIn(slider.vars.animationDuration); 
      }
      ///////////////////////////////////////////////////////////////////
