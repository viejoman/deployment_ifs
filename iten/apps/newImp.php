...
<script>
	$(function(){
		...
		<form class="form-horizontal">
			<fieldset>
				<legend>Nuevo itinerario de <em>Importación</em> del mes de <span id="mess" class="badge badge-info" title="Cambiar mes" data-date="<?php echo date("j-m-Y"); ?>" data-date-format="d-mm-yyyy"><?php $m = date("m");  echo format_mes($m); ?></span></legend>
				<div class="row">
					<div class="span5">
						...
						<div class="control-group">
							<label class="control-label" for="puerto">Puerto de descarga</label>
							<div class="controls">
